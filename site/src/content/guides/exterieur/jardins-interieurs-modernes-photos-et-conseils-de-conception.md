---
title: "Jardins intérieurs modernes : idées et conseils pour un espace vert design"
description: "Crée un jardin intérieur moderne avec nos conseils de conception, plantes idéales et astuces déco pour un espace vert stylé chez toi."
type: guide
branch: exterieur
parent: exterieur
order: 5
...
```mermaid
flowchart TD
    A["Jardin intérieur moderne"]:::main --> B["Lignes épurées"]:::second
    A --> C["Matériaux bruts"]:::second
    A --> D["Plantes sculpturales"]:::second
    B --> E["Pots géométriques\nCylindres, cubes"]:::main
    C --> F["Métal + béton\nBois composite + verre"]:::main
    D --> G["Ficus lyrata\nStrelitzia, Monstera"]:::main
...
```mermaid
flowchart LR
    A["Lumière naturelle\n< 2m de la fenêtre"]:::main --> B["Plantes tropicales\nFicus, Monstera"]:::second
    C["LED horticole\n12-18 EUR/ampoule"]:::main --> D["Zones sombres\nCouloir, salle de bain"]:::second
    E["LED déco 3000K\n15-25 EUR/5m"]:::main --> F["Mise en valeur\nHalo, rétro-éclairage"]:::second

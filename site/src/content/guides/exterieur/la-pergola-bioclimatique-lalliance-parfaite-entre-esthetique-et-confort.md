---
title: "Pergola bioclimatique : l'alliance parfaite entre esthétique et confort"
description: "Pergola bioclimatique : comment transformer ta terrasse en espace de vie 4 saisons avec style. Lames orientables, matériaux, budget et marques sélectionnés."
type: guide
branch: exterieur
parent: exterieur
order: 8
...
graph TD
    ...
    A --> B[Structure aluminium]
    A --> C[Structure bois/hybride]
    B --> D[Zéro entretien]
    B --> E[Design contemporain]
    B --> F[Large palette de couleurs]
    C --> G[Rendu chaleureux]
    C --> H[S'intègre aux maisons anciennes]
    C --> I[Entretien régulier requis]
...
flowchart LR
    Pergola --> Eclairage
    Pergola --> Stores_lateraux
    Pergola --> Chauffage
    Pergola --> Capteurs_auto

    Eclairage --> LED_integrees
    Eclairage --> Spots_orientables

    Stores_lateraux --> ZIP_motorise
    Stores_lateraux --> Brise_vue_coulissant

    Chauffage --> Infrarouge
    Chauffage --> Radiateur_electrique

    Capteurs_auto --> Pluie
    Capteurs_auto --> Vent
    Capteurs_auto --> Luminosite

    style Pergola fill:#FFF0F5,stroke:#E879F9,color:#701A75
    style Eclairage fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    style Stores_lateraux fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    style Chauffage fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    style Capteurs_auto fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    style LED_integrees fill:#F9FAFB,stroke:#6B7280,color:#374151
    style Spots_orientables fill:#F9FAFB,stroke:#6B7280,color:#374151
    style ZIP_motorise fill:#F9FAFB,stroke:#6B7280,color:#374151
    style Brise_vue_coulissant fill:#F9FAFB,stroke:#6B7280,color:#374151
    style Infrarouge fill:#F9FAFB,stroke:#6B7280,color:#374151
    style Radiateur_electrique fill:#F9FAFB,stroke:#6B7280,color:#374151
    style Pluie fill:#F9FAFB,stroke:#6B7280,color:#374151
    style Vent fill:#F9FAFB,stroke:#6B7280,color:#374151
    style Luminosite fill:#F9FAFB,stroke:#6B7280,color:#374151
```

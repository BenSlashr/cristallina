---
title: "Construire un pool house : guide complet pour un espace piscine au top"
description: "Construire un pool house : budget, matériaux, démarches et aménagement. Tous les conseils pour créer ton espace détente au bord de la piscine."
type: guide
branch: exterieur
parent: exterieur
order: 6
...
```mermaid
graph TD
    A["Surface du pool house"]
    A --> B["Moins de 5 m2"]
    A --> C["5 à 20 m2"]
    A --> D["Plus de 20 m2"]
    B --> E["Aucune formalité"]
    C --> F["Déclaration préalable - Cerfa 13703"]
    D --> G["Permis de construire - Cerfa 13406"]
    D --> H["Architecte si total > 150 m2"]
...
```mermaid
graph LR
    A["Pool house aménagé"]
    A --> B["Zone vestiaire"]
    A --> C["Cuisine d'été"]
    A --> D["Rangement technique"]
    A --> E["Espace détente"]
    B --> F["Douche + banc + patères"]
    C --> G["Évier + plancha + frigo"]
    D --> H["Produits + robot + local technique"]
    E --> I["Salon + bar + transats"]

---
title: "Jardinières suspendues DIY : 6 idées faciles à fabriquer soi-même"
description: "Fabrique tes jardinières suspendues avec nos 6 tutos faciles. Macramé, bois, récup : des idées DIY pour un intérieur ou un balcon verdoyant."
type: guide
branch: exterieur
parent: exterieur
order: 9
...
```mermaid
flowchart LR
    A["Couper 8 brins\nde 2 m"] --> B["Passer dans\nl'anneau"]
    B --> C["Noeud de blocage"]
    C --> D["4 groupes\n= 4 noeuds plats"]
    D --> E["Noeuds croisés\nentre groupes"]
    E --> F["Noeud final\n+ franges"]
...
quadrantChart
    ...
    Macramé: [0.25, 0.20]
    Cadre bois: [0.30, 0.25]
    Échelle: [0.55, 0.60]
    Cornets Fimo: [0.50, 0.20]
    Bulles verre: [0.20, 0.18]
    Portant: [0.10, 0.35]
```

---
title: "Couleurs facades maison 2026 : tendances et palettes pour tes extérieurs"
description: "Les couleurs tendance 2026 pour façades et extérieurs de maisons : teintes nature, gris anthracite, terracotta. Conseils, marques et prix pour bien choisir."
type: guide
branch: exterieur
parent: exterieur
order: 8
...
```mermaid
graph TD
    A["Quel est ton type de façade ?"] --> B["Enduit"]
    A --> C["Bardage bois"]
    A --> D["Pierre naturelle"]
    B --> E["Teintes libres : neutres,\n terracotta, verts, gris"]
    C --> F["Lasures ou peintures :\n verts, gris, bleu profond"]
    D --> G["Adapter menuiseries\n et volets à la pierre"]
    E --> H["Finition : grattée,\n talochée ou lisse"]
    F --> I["Finition : mate, satinée\n ou semi-brillante"]
    G --> J["Finition : couleur\n des boiseries et accents"]
...
```mermaid
graph LR
    A["Palettes 2026"] --> B["Nature zen"]
    A --> C["Chic urbain"]
    A --> D["Méditerranée\n douce"]
    A --> E["Classique\n intemporelle"]
    A --> F["Scandinave\n chaleureuse"]
    B --> B1["Vert sauge\n + blanc lin"]
    C --> C1["Gris anthracite\n + noir + jaune"]
    D --> D1["Terracotta\n + blanc + bleu"]
    E --> E1["Blanc cassé\n + pierre + gris"]
    F --> F1["Bois noir\n + bois clair"]
    ...
    style D1 fill:#FEF3F2,stroke:#F97316,color:#9A3412
    style E1 fill:#FEF3F2,stroke:#F97316,color:#9A3412
    style F1 fill:#FEF3F2,stroke:#F97316,color:#9A3412
```

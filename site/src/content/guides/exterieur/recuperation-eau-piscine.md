---
title: "Récupération eau piscine : comment remplir son bassin en économisant l'eau"
description: "Recycle l'eau de pluie pour ta piscine et réduis ta facture. Installation, traitement, cuve : tout ce qu'il faut savoir pour être autonome cet été."
type: guide
branch: exterieur
parent: exterieur
order: 3
...
```mermaid
flowchart TD
    A[Eau de pluie collectee]
    B[Filtre grossier - toiture et gouttiere]
    C[Cuve de stockage]
    D[Filtre fin en sortie]
    E[Correction pH - carbonate de calcium]
    F[Desinfection - chlore ou sel]
    G[Bassin piscine]
    H[Filtration habituelle du bassin]
...
flowchart LR
    A[Saison ete]
    B[Traitement hivernation - octobre]
    C[Couverture opaque ou bulle]
    D[Filtration lente - 2h par jour]
    E[Ouverture de saison - mai]
    F[Test eau - ajustements mineurs]
    G[Piscine prete]

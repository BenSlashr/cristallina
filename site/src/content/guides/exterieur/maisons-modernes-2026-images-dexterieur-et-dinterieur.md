---
title: "Maisons modernes 2026 : les plus belles images d'extérieur et d'intérieur"
description: "Découvre les tendances des maisons modernes en 2026 : façades, plans, matériaux et idées déco intérieur pour une maison design qui te ressemble."
type: guide
branch: exterieur
parent: exterieur
order: 1
...
```mermaid
flowchart TD
    A["Choisir ton plan de maison"] --> B["Terrain disponible ?"]
    B -->|"Grand terrain"| C["Plain-pied"]
    B -->|"Terrain étroit"| D["Maison à étage"]
    C --> E["Espace de vie au sol\nJardin accessible direct\nIdéal famille avec enfants"]
    D --> F["Vue dégagée depuis étage\nEspaces de nuit séparés\nEmpreinte réduite au sol"]
    E --> G["Budget construction\n~1 400-1 800 €/m²"]
    F --> H["Budget construction\n~1 200-1 600 €/m²"]
...
graph LR
    ...
    A --> D["Pierre\nnaturelle"]
    A --> E["Béton\nciré/brut"]
    B --> F["Fenêtres, rampes\nd'escalier, robinetterie"]
    C --> G["Plans de travail\nsols, salle de bain"]
    D --> H["Façades\nmurs accent"]
    E --> I["Sols, plans de\ntravail, cuisine"]
    style A fill:#FFF0F5,stroke:#E879F9,color:#701A75
    style B fill:#F3F4F6,stroke:#8B5CF6,color:#581C87

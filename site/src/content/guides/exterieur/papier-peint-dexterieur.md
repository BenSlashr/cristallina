---
title: "Papier peint d'extérieur : le guide pour décorer tes murs en plein air"
description: "Le papier peint d'extérieur résiste aux intempéries et transforme tes façades. Guide complet : matériaux, pose, entretien et inspirations."
type: guide
branch: exterieur
parent: exterieur
order: 5
...
```mermaid
graph TD
    A["Quel support pour ton mur ?"]
    A --> B{"Type de mur ?"}
    B -->|"Façade enduite / lisse"| C["Fibre de verre collée"]
    B -->|"Parpaing brut"| D["Fibre de verre + enduit de lissage"]
    B -->|"Mur humide / irrégulier"| E["Panneau alu sur entretoises"]
    C --> F["40-90 euros/m2"]
    D --> G["50-110 euros/m2"]
    E --> H["150-300 euros/panneau"]

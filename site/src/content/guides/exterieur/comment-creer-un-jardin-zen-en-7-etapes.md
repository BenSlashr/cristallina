---
title: "Jardin zen : comment en créer un en 7 étapes concrètes"
description: "Crée ton propre jardin zen en 7 étapes claires : emplacement, plantes, gravier, eau, pierres et entretien. Guide complet pour aménager un espace de sérénité."
type: guide
branch: exterieur
parent: exterieur
order: 6
...
```mermaid
flowchart TD
    A["Espace disponible"]:::rose --> B["Petit < 10m2"]:::violet
    A --> C["Moyen 10-30m2"]:::orange
    A --> D["Grand > 30m2"]:::neutre
    B --> E["Karesansui pur\nGravier + 3 à 5 pierres"]:::rose
    C --> F["Zones mixtes\nGravier + eau + plantes"]:::violet
    D --> G["Jardin complet\nToutes les zones"]:::orange
...
```mermaid
flowchart LR
    A["Sol préparé\n+ géotextile"]:::rose --> B["Gravier\n6-8cm"]:::violet
    B --> C["Pierres\nen impair"]:::orange
    C --> D["Chemins\nen pas japonais"]:::neutre
    D --> E["Ratissage\ndes motifs"]:::rose

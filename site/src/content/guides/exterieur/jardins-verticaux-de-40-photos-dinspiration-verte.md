---
title: "Jardins verticaux : 40 photos d'inspiration verte pour murs et balcons"
description: "Jardin vertical intérieur ou extérieur : 40 idées en photos, plantes adaptées, systèmes de fixation, budget et conseils pratiques pour végétaliser tes murs."
type: guide
branch: exterieur
parent: exterieur
order: 9
...
```mermaid
flowchart TD
    A["Quel jardin vertical choisir ?"]:::rose --> B["Budget < 50 EUR"]:::violet
    A --> C["Budget 100-300 EUR"]:::violet
    A --> D["Budget > 500 EUR"]:::orange
    B --> E["Palette recyclée\nou poches feutre"]:::rose
    C --> F["Modules Minigarden\n+ goutte-à-goutte"]:::rose
    D --> G["Mur hydroponique\npro ou semi-pro"]:::neutre
...
```mermaid
flowchart LR
    A["1. Préparer\nle mur"]:::rose --> B["2. Fixer\nle support"]:::violet
    B --> C["3. Installer\nles poches"]:::rose
    C --> D["4. Planter\n(haut vers bas)"]:::violet
    D --> E["5. Arrosage\ngoutte-à-goutte"]:::orange

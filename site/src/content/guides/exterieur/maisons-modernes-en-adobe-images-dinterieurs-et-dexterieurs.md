---
title: "Maisons modernes en adobe : les plus belles images d'intérieurs et d'extérieurs"
description: "Découvre les plus belles maisons modernes en adobe : images d'intérieurs et d'extérieurs, inspirations déco, matériaux et conseils pour ton projet."
type: guide
branch: exterieur
parent: exterieur
order: 2
...
flowchart TD
    ...
    B --> C[Moulage en briques]:::secondary
    C --> D[Séchage naturel au soleil]:::neutral
    D --> E[Maçonnerie et pose]:::neutral
    E --> F[Enduit de finition - argile ou chaux]:::accent
...
```mermaid
graph LR
    subgraph EXT["Extérieur - Caractéristiques visuelles"]
        A[Façades terre crue\nteintes naturelles]:::main
        B[Volumes simples\nangles arrondis]:::secondary
        C[Toit plat\nou légèrement incliné]:::neutral
        D[Grandes ouvertures\ncontrastées]:::accent
    end
...
flowchart LR
    ...
    A --> C[Blocs Terrabloc\n~150€/m² posé]:::secondary
    A --> D[Main d'oeuvre spécialisée\n+20 à 30% vs béton classique]:::accent
    A --> E[Enduit finition\n15-40€/m² selon type]:::neutral

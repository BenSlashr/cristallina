---
title: "Profiter de son extérieur en pleine canicule : 10 astuces fraîcheur"
description: "Pergola, brumisateur, plantes et ombre naturelle : 10 solutions pour profiter de ton jardin ou ta terrasse même quand il fait très chaud."
type: guide
branch: exterieur
parent: exterieur
order: 2
...
```mermaid
graph TD
    A["Solutions eau pour rafraîchir le jardin"]
    A --> B["Bassin 1-3 m2"]
    A --> C["Fontaine murale"]
    A --> D["Brumisateur"]
    A --> E["Jeux d'eau"]
    B --> F["50-150 euros - Baisse 2-3 degrés"]
    C --> G["60-300 euros - Eau en mouvement"]
    D --> H["30-250 euros - Baisse 5-10 degrés"]
    E --> I["10-50 euros - Fun et frais"]
...
graph LR
    ...
    C --> C3["Arrosage soir"]
    D --> D1["Bois composite"]
    D --> D2["Gravillons clairs"]
    E --> E1["Courant naturel"]
    E --> E2["Ventilateur extérieur"]
    ...
    style B2 fill:#FFF0F5,stroke:#E879F9,color:#701A75
    style B3 fill:#FFF0F5,stroke:#E879F9,color:#701A75
    style C1 fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    style C2 fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    style C3 fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    style D1 fill:#FFF0F5,stroke:#E879F9,color:#701A75
    style D2 fill:#FFF0F5,stroke:#E879F9,color:#701A75
    style E1 fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    style E2 fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
```
...
graph TD
    A["Budget disponible ?"]
    A --> B{"Moins de 100 euros"}
    A --> C{"100 à 500 euros"}
    A --> D{"Plus de 500 euros"}
    B --> E["Parasol + paillage + arrosage soir"]
    C --> F["Store banne + brumisateur + plantes"]
    D --> G["Pergola bioclimatique + bassin + arbres"]

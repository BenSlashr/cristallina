---
title: "Patio moderne : idées d'aménagement pour un extérieur stylé"
description: "Crée un patio moderne et accueillant avec nos idées d'aménagement. Matériaux, mobilier et végétation pour un espace extérieur qui a du caractère."
type: guide
branch: exterieur
parent: exterieur
order: 10
...
```mermaid
graph TD
    A["Quel matériau pour ton patio ?"]
    A --> B{"Quel style recherché ?"}
    B -->|"Ultra contemporain"| C["Béton ciré ou lissé"]
    B -->|"Chaleureux et naturel"| D["Bois durable - Kebony, teck"]
    B -->|"Minéral et élégant"| E["Pierre naturelle grand format"]
    C --> F["Budget : 60-120 euros/m2"]
    D --> G["Budget : 80-130 euros/m2"]
    E --> H["Budget : 50-100 euros/m2"]
...
```mermaid
graph LR
    A["Protection du patio"] --> B["Pergola"]
    A --> C["Voiles d'ombrage"]
    A --> D["Auvent acier/verre"]
    B --> E["1 500-4 000 euros"]
    B --> F["Look architecte"]
    C --> G["100-400 euros"]
    C --> H["Look aérien"]
    D --> I["2 000-6 000 euros"]
    D --> J["Lumière + protection pluie"]
...
```mermaid
pie title Répartition budget patio moderne
    "Sol et revêtement" : 35
    "Structure - pergola ou auvent" : 25
    "Mobilier" : 20
    "Éclairage" : 10
    "Végétation et pots" : 10
```

---
title: "Déco terracotta chambre : comment créer une ambiance chaude et cocooning"
description: "Adopte la couleur terracotta dans ta chambre : associations de couleurs, styles, murs, textiles et astuces déco pour une pièce chaleureuse et apaisante."
type: guide
branch: chambre
parent: chambre
order: 3
...
graph LR
    T["Terracotta"]
    T --> M["Méditerranéen\nCarrelage, rotin, lin"]
    T --> B["Bohème\nMacramé, plantes, layers"]
    T --> S["Scandinave chaud\nBois clair, blanc, minimaliste"]
    T --> J["Japandi\nBambou, béton, épuré"]

    style T fill:#FEF3F2,stroke:#F97316,color:#9A3412
    style M fill:#FFF0F5,stroke:#E879F9,color:#701A75
    style B fill:#FFF0F5,stroke:#E879F9,color:#701A75
    style S fill:#F3F4F6,stroke:#8B5CF6,color:#581C87

---
title: "Déco chambre Harry Potter : créer une atmosphère de Poudlard sans se ruiner"
description: "Transforme ta chambre en espace magique façon Harry Potter : idées déco, DIY, couleurs et accessoires pour vivre dans l'univers de Poudlard au quotidien."
type: guide
branch: chambre
parent: chambre
order: 2
...
```mermaid
flowchart TD
    A[Quelle ambiance Harry Potter ?]:::principal --> B[Poudlard - château]:::secondaire
    A --> C[Maison de sorcier]:::secondaire
    B --> D[Couleurs : gris pierre, or, bordeaux]:::accent
    B --> E[Textures : bois sombre, velours, lin]:::neutre
    C --> F[Couleurs : rouge, ocre, vert profond]:::accent
    C --> G[Objets : baguettes, livres, lanternes]:::neutre
    D --> H[Ambiance choisie - direction claire]:::principal
    E --> H
    F --> H
    G --> H
...
```mermaid
flowchart LR
    A[Mur d'entrée]:::neutre --> B[Couleur accent]:::principal
    C[Murs latéraux]:::neutre --> D[Blanc cassé ou gris clair]:::neutre
    E[Mur derrière le lit]:::neutre --> F[Galerie de cadres]:::secondaire
    F --> G[Mix illustrations vintage + photos]:::accent
    B --> H[Bordeaux, vert foncé ou bleu nuit]:::principal
    H --> I[Un seul mur suffit]:::principal

    style A fill:#F9FAFB,stroke:#6B7280,color:#374151

---
title: "Chambre style jungle : idées déco pour une ambiance tropicale chez toi"
description: "Plantes, matières naturelles, couleurs profondes : transforme ta chambre en refuge tropical avec des idées concrètes et des prix réels."
type: guide
branch: chambre
parent: chambre
order: 9
...
```mermaid
graph TD
    A["Quelle luminosité dans ta chambre ?"]
    A --> B["Bonne lumière\n(fenêtre au sud/est)"]
    A --> C["Lumière moyenne\n(fenêtre au nord/ouest)"]
    A --> D["Peu de lumière"]
    B --> E["Monstera deliciosa\nFicus lyrata\nStrelitzia"]
    C --> F["Pothos doré\nSansevière\nSpathiphyllum"]
    D --> G["Pothos\nAspidistra\nFilodendron Brasil"]

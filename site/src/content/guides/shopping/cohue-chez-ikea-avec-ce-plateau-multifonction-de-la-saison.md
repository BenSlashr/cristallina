---
title: "Plateau multifonction IKEA : pourquoi tout le monde se l'arrache"
description: "SMÅÄTA, RESGODS, GRILLTIDER : les plateaux IKEA stars de la saison. Comparatif, prix et 8 façons de les utiliser au quotidien."
type: guide
branch: shopping
parent: shopping
order: 6
...
<div class="my-8">
  <img src="/images/pinterest-rangement-chambre-organisation-dressing-optimis--1771234773795.jpg" alt="Cohue chez ikea avec ce plateau multifonction de la saison - inspiration decoration" class="w-full rounded-lg shadow-sm" loading="lazy" />
</div>
...
<div class="my-8">
  <img src="/images/pinterest-rangement-chambre-organisation-dressing-optimis--1771234771218.jpg" alt="Cohue chez ikea avec ce plateau multifonction de la saison - amenagement et design" class="w-full rounded-lg shadow-sm" loading="lazy" />
</div>


```mermaid
graph TD
    A[Quel plateau IKEA choisir ?]:::principal --> B{Ton usage principal ?}:::secondaire
    B --> C[Table & condiments]:::principal
    B --> D[Petit-déjeuner & canapé]:::secondaire
    B --> E[Extérieur & barbecue]:::principal
    C --> F[SMÅÄTA - 19,99 euros]:::secondaire
    D --> G[RESGODS - 14,99 euros]:::principal
    E --> H[GRILLTIDER - 9,99 euros]:::secondaire
...
Si tu as une cuisine ouverte sur le salon, un plateau bien garni fait office de tampon visuel entre l'espace cuisine et l'espace vie. Un SMÅÄTA avec de belles huiles, du vinaigre dans une jolie bouteille et des herbes fraiches dans un petit pot, ça donne un côté authentique et chic. Tu trouveras d'autres inspirations dans notre guide sur la [décoration de cuisine](/decoration-cuisine/).
...
<div class="my-8">
  <img src="/images/pinterest-d-coration-minimaliste--pur--scandinave-simple-blanc-1771238438611.jpg" alt="Cohue chez ikea avec ce plateau multifonction de la saison - style et ambiance" class="w-full rounded-lg shadow-sm" loading="lazy" />
</div>
...
```mermaid
graph LR
    A[Nouveautés IKEA 2026]:::principal --> B[Färgsättare - 30 euros]:::secondaire
    A --> C[Hundhaj - 3 euros]:::secondaire
    A --> D[TROTTEN bureau - 179 euros]:::principal
    A --> E[SMÅÄTA plateau - 19,99 euros]:::secondaire
...
<div class="my-8">
  <img src="/images/pinterest-d-coration-minimaliste--pur--scandinave-simple-blanc-1771238413119.jpg" alt="Cohue chez ikea avec ce plateau multifonction de la saison - decoration interieure" class="w-full rounded-lg shadow-sm" loading="lazy" />
</div>

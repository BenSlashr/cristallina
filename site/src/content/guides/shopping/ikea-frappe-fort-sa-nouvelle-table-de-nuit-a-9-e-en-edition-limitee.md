---
title: "Tables de nuit IKEA à petit prix : KULLEN, TARVA et les bons plans 2026"
description: "KULLEN dès 29 EUR, KNARREVIK à 9,99 EUR, TARVA en pin : comparatif des tables de chevet IKEA pas chères. Éditions limitées et astuces déco."
type: guide
branch: shopping
parent: shopping
order: 6
...
```mermaid
flowchart TD
    A[Quel est ton budget ?] --> B{Moins de 15 euros}
    A --> C{Entre 25 et 40 euros}
    A --> D{Plus de 40 euros}
    B --> E[KNARREVIK métal noir - 9,99 euros]
    C --> F[KULLEN 2 tiroirs - 29 euros]
    C --> G[TARVA pin brut - 39 euros]
    D --> H[MALM 2 tiroirs - 49 euros]
    D --> I[TONSTAD blanc cassé - 69 euros]
...
```mermaid
flowchart LR
    A[Style chambre] --> B[Industriel / Minimaliste]
    A --> C[Scandinave / Naturel]
    A --> D[Contemporain / Classique]
    B --> E[KNARREVIK métal noir]
    C --> F[TARVA pin brut]
    D --> G[MALM ou TONSTAD]

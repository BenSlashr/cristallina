---
title: "Lampe articulée IKEA à petit prix : le coup de coeur déco de la saison"
description: "IKEA fait sensation avec ses lampes articulées design et pas chères. TERTIAL, HEKTAR, FADO : comparatif des modèles à moins de 15 euros."
type: guide
branch: shopping
parent: shopping
order: 7
...
```mermaid
graph TD
    A[Lampes IKEA petit prix]:::main --> B[TERTIAL 12,99 EUR]:::secondary
    A --> C[FADO 19,99 EUR]:::secondary
    A --> D[KUDDLAVA 9,99 EUR]:::secondary
    B --> E[Articulée bureau/atelier]:::detail
    B --> F[Bras à ressort E27]:::detail
    C --> G[Globe verre opale]:::detail
    C --> H[Ambiance tamisée]:::detail
...
```mermaid
graph LR
    A[Quelle pièce ?]:::main --> B[Bureau]:::secondary
    A --> C[Chambre]:::secondary
    A --> D[Salon]:::secondary
    B --> E[TERTIAL<br/>Éclairage dirigé]:::detail
    C --> F[FADO ou KUDDLAVA<br/>Lumière douce]:::detail
    D --> G[NYMO/SKAFTET<br/>Ambiance décorative]:::detail
    D --> H[TERTIAL sur étagère<br/>Coin lecture]:::detail

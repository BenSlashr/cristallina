---
title: "Couleurs ocres pour les murs et la décoration : le guide complet"
description: "Ocre jaune, ocre rouge, terre brûlée : comment utiliser les couleurs ocres sur tes murs et dans ta déco pour un intérieur chaud et moderne."
type: guide
branch: couleurs
parent: couleurs
order: 2
...
> [!NOTE]
> L'ocre rouge et la terracotta sont proches mais pas identiques. La terracotta tire davantage vers le rouge brique, l'ocre rouge reste plus lumineux et plus chaud. Pour tout savoir sur la déco terracotta en chambre, j'ai écrit un article dédié : [déco terracotta pour la chambre](/guides/decoration/deco-terracotta-chambre/).
...
```mermaid
graph TD
    A[Ocre - couleur principale]:::rose --> B[Blanc cassé]:::violet
    A --> C[Bleu cobalt / canard]:::orange
    A --> D[Vert olive]:::violet
    A --> E[Taupe / gris chaud]:::neutre
    A --> F[Terracotta / brique]:::orange

    classDef rose fill:#FFF0F5,stroke:#E879F9,color:#701A75
    classDef violet fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    classDef orange fill:#FEF3F2,stroke:#F97316,color:#9A3412
...
flowchart LR
    ...
    B --> B1[Mur accent ou all-in\nOcre vif + blanc cassé]:::neutre
    C --> C1[Mur tête de lit\nOcre doux + lin blanc]:::neutre
    D --> D1[Façades ou murs\nOcre + zellige ou marbre]:::neutre
    E --> E1[Oser la saturation\nOcre intense + laiton]:::neutre
...
L'orange étant une couleur complémentaire de l'ocre, les deux travaillent d'ailleurs souvent ensemble dans les palettes actuelles - pour creuser ce sujet, mon article sur les [couleurs compatibles avec l'orange pour les murs](/guides/decoration/couleurs-compatibles-avec-lorange-pour-les-murs-et-la-decoration/) te donnera beaucoup d'idées supplémentaires.

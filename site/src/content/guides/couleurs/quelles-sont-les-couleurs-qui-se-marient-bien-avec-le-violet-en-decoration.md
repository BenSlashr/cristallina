---
title: "Couleurs qui se marient avec le violet : guide déco complet"
description: "Quelles couleurs associer au violet pour une déco réussie ? Jaune moutarde, gris, blanc, vert olive... toutes les combinaisons testées et validées."
type: guide
branch: couleurs
parent: couleurs
order: 3
...
```mermaid
flowchart TD
    A["Violet - couleur de base"]
    A --> B["Complémentaire\nJaune / Moutarde"]
    A --> C["Analogue\nBleu / Rose"]
    A --> D["Neutre\nGris / Blanc / Beige"]
    A --> E["Contraste végétal\nVert olive / Vert sauge"]
...
```mermaid
graph LR
    A["Pièce & Style"] --> B["Chambre calme"]
    A --> C["Salon contemporain"]
    A --> D["Bureau créatif"]
    A --> E["Cuisine originale"]

    B --> F["Lavande + gris perle\nou bleu gris"]
    C --> G["Violet vif + gris\nou jaune moutarde"]
    D --> H["Prune + blanc cassé\nou vert sauge"]
    E --> I["Violet pâle + crème\nou bois naturel"]

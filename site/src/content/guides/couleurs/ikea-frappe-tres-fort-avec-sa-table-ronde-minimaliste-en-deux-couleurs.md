---
title: "Table ronde IKEA minimaliste : le modèle en deux couleurs qui fait craquer tout le monde"
description: "Découvre la table ronde minimaliste IKEA en noir ou blanc. Design épuré, prix mini et convivialité pour ton intérieur."
type: guide
branch: couleurs
parent: couleurs
order: 3
...
graph TD
    ...
    A --> C[Plateau laqué blanc]:::secondaire
    B --> D[LISABO - plaqué frêne]:::principal
    B --> E[SKANSNÄS - hêtre]:::secondaire
    B --> F[GRÖTÅN - aspect chêne]:::principal
    C --> G[DOCKSTA - résine blanche]:::secondaire
...
```mermaid
flowchart LR
    A[Table IKEA minimaliste]:::principal --> B[Style scandinave]:::secondaire
    A --> C[Style contemporain]:::secondaire
    A --> D[Style loft/industriel]:::secondaire
    B --> E[Chaises bois clair + tapis laine]:::principal
    C --> F[Chaises transparentes + métal]:::secondaire
    D --> G[Chaises métal noir + béton]:::principal
...
- [étagère murale ikea](/ikea-frappe-fort-avec-cette-etagere-design-et-tres-pratique-qui-saccroche-au-mur-tres-facilement/)
...
```mermaid
flowchart TD
    A{Quel est ton besoin principal ?}:::principal
    A --> B[Design et esthétique pure]:::secondaire
    A --> C[Polyvalence et flexibilité]:::secondaire
    A --> D[Budget maîtrisé]:::secondaire
    B --> E[DOCKSTA blanc piédestal]:::principal
    B --> F[LISABO frêne naturel]:::secondaire
    C --> G[SKANSNÄS extensible]:::principal
    D --> H[GRÖTÅN bois + métal noir]:::secondaire

---
title: "Peinture sur carrelage : la méthode complète pour rénover sans casser"
description: "Peindre son carrelage soi-même en un week-end : préparation, choix de la peinture époxy, application et astuces pour un résultat durable."
type: guide
branch: couleurs
parent: couleurs
order: 5
...
```mermaid
flowchart TD
    A["Dégraissage + nettoyage"]:::principal
    B["Séchage 24h minimum"]:::neutre
    C["Réparation joints/fissures"]:::secondaire
    D["Application sous-couche"]:::secondaire
    E["Séchage sous-couche"]:::neutre
    F["1ère couche de peinture"]:::principal
    G["Séchage 24h"]:::neutre
    H["2ème couche de peinture"]:::principal
    I["Séchage 48h avant utilisation"]:::neutre
    J["Vernis de finition optionnel - sol uniquement"]:::accent
...
```mermaid
flowchart LR
    subgraph Erreurs["Erreurs classiques"]
        E1["Peindre sur carrelage humide"]:::accent
        E2["Sauter la sous-couche"]:::accent
        E3["Passer trop vite la 2ème couche"]:::accent
        E4["Utiliser le sol trop tôt"]:::accent
    end
    subgraph Solutions["La bonne approche"]
        S1["Séchage 24h minimum"]:::principal
        S2["Dégraissage + primer si lisse"]:::principal
        S3["Respecter les 24h entre couches"]:::principal
        S4["Attendre 72h avant usage"]:::principal
    end
    E1 --> S1
    E2 --> S2
    E3 --> S3

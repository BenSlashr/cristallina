---
title: "Cuisine rustique chic : créer un look rétro chaleureux et élégant"
description: "Cuisine rustique chic : matériaux, couleurs, meubles et accessoires pour un style rétro élégant. Guide complet avec prix, marques et erreurs à éviter."
type: guide
branch: cuisine
parent: cuisine
order: 8
...
```mermaid
graph TD
    A[Matériaux rustique chic]:::principal --> B[Bois massif]:::secondaire
    A --> C[Pierre et céramique]:::secondaire
    A --> D[Métaux chauds]:::accent
    B --> E[Chêne brut]:::neutre
    B --> F[Noyer huilé]:::neutre
    B --> G[Bois recyclé]:::neutre
    C --> H[Tomette terre cuite]:::neutre
    C --> I[Zellige artisanal]:::neutre
    C --> J[Carrelage pierre]:::neutre
    D --> K[Laiton brossé]:::neutre
    D --> L[Cuivre]:::neutre
    D --> M[Fer forgé]:::neutre
...
```mermaid
graph LR
    A[Budget électroménager rétro]:::principal --> B[Premium]:::secondaire
    A --> C[Mid-range]:::accent
    A --> D[Malin]:::neutre
    B --> E["Smeg FAB28 : 1800€<br>La Cornue : 8000€+"]:::secondaire
    C --> F["Gorenje Retro : 600€<br>Schneider : 500€"]:::accent
    D --> G["Four classique + hotte<br>rétro cuivre : 300-500€"]:::neutre
...
```mermaid
graph TD
    A[Cuisine rustique chic<br>par budget]:::principal --> B["Petit budget<br>500 - 1500€"]:::secondaire
    A --> C["Budget moyen<br>2000 - 5000€"]:::accent
    A --> D["Grand budget<br>8000€+"]:::neutre
    B --> E[Étagères bois brut<br>Poignées laiton<br>Peinture façades]:::secondaire
    C --> F[Façades chêne plaqué<br>Zellige crédence<br>Robinetterie rétro]:::accent
    D --> G[Chêne massif<br>Pierre naturelle<br>Électroménager Smeg]:::neutre

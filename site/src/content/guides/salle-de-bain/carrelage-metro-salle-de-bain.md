---
title: "Carrelage métro salle de bain : idées, pose et prix pour bien choisir"
description: "Carrelage métro pour ta salle de bain : couleurs, formats, finitions, techniques de pose et prix. Guide complet pour un résultat beau et durable."
type: guide
...
```mermaid
flowchart LR
    A["Choix de finition"] --> B["Brillant"]
    A --> C["Mat"]
    A --> D["Biseauté"]
    A --> E["Plat"]
    B --> F["+ luminosité\n+ agrandissement\n- traces visibles"]

---
title: "Carrelage douche italienne : comment bien le choisir"
description: "Tout ce qu'il faut savoir pour choisir le carrelage de ta douche à l'italienne : formats, matières, couleurs, antidérapant et budget. Guide pratique."
type: guide
...
```mermaid
flowchart TD
    A[Choisir le format] --> B{Taille de ta douche}
    B -->|Petite douche <br> moins de 1m²| C[Petits formats <br> 10x10, 15x15, mosaïque]
    B -->|Douche standard <br> 80x80 à 100x100| D[Formats moyens <br> 30x60, 60x60, 20x20]
    B -->|Grande douche <br> plus de 120x120| E[Grands formats <br> 60x120, 90x90, 120x120]
    C --> F[Effet graphique, <br> moins de découpes, <br> plus de joints]
    D --> G[Polyvalent, <br> équilibre visuel <br> et technique]
    E --> H[Effet spacieux, <br> moins de joints, <br> découpes complexes]
...
```mermaid
flowchart LR
    A[Ambiance souhaitée] --> B[Zen et épurée]
    A --> C[Chaleureuse et naturelle]
    A --> D[Graphique et moderne]
    A --> E[Colorée et personnelle]
    B --> B1[Blanc mat / gris clair <br> Grand format <br> Joints fins blancs]
    C --> C1[Beige / terracotta / bois <br> Zellige ou pierre <br> Joints sable ou gris chaud]
    D --> D1[Gris béton / anthracite <br> Grands formats <br> Joints anthracite]
    E --> E1[Couleur franche ou mosaïque <br> 1 mur accent <br> Joints assortis]

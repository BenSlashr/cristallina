---
title: "Salle de bain rustique moderne : idées déco et design"
description: "Crée une salle de bain rustique moderne avec du bois, de la pierre et des lignes épurées. Inspirations et conseils pour un style campagne chic."
type: guide
...
flowchart LR
    ...
    B --> C["Touches profondes\nVert sauge / Brun chocolat"]
...
```mermaid
flowchart TD
    A["Salle de bain rustique moderne"] --> B["Matériaux"]
    A --> C["Mobilier"]
    A --> D["Détails"]
    B --> B1["Bois brut\nteck, chêne, récup"]
    B --> B2["Pierre naturelle\ntravertin, parement"]
    B --> B3["Céramique\nzellige, faïence"]
    C --> C1["Vasque posée\npierre ou béton"]
    C --> C2["Meuble bois\nmassif, simple"]
    C --> C3["Étagères ouvertes\npas de placards hauts"]
    D --> D1["Robinetterie\nnoir mat, laiton"]
    D --> D2["Miroir rond\nbois ou sans cadre"]
    D --> D3["Textiles\nlin, coton brut"]
    style A fill:#FFF0F5,stroke:#E879F9,color:#701A75
...
```mermaid
flowchart LR
    A["Budget malin\n1 500 - 3 000 euros"] --> B["Budget confort\n3 000 - 7 000 euros"]
    B --> C["Budget premium\n7 000 - 15 000 euros"]
    A --- A1["Grès imitation pierre\nMeuble vasque IKEA\nRobinet noir entrée gamme"]
    B --- B1["Travertin sol\nMeuble teck massif\nRobinetterie Grohe"]
    C --- C1["Pierre naturelle partout\nVasque sur mesure\nLaiton brossé haut gamme"]
    style A fill:#FFF0F5,stroke:#E879F9,color:#701A75
    style B fill:#FFF0F5,stroke:#E879F9,color:#701A75
    style C fill:#FFF0F5,stroke:#E879F9,color:#701A75

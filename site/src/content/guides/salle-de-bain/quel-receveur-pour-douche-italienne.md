---
title: "Receveur pour douche italienne : quel modèle choisir selon ton projet"
description: "Extra-plat, à carreler, encastré en résine : quel receveur de douche italienne choisir selon ton budget, ta config et tes contraintes ? Le guide complet."
type: guide
...
```mermaid
flowchart TD
    A["Quel est ton contexte ?"]
    A --> B["Rénovation légère"]
    A --> C["Rénovation lourde\nou construction neuve"]
    B --> D["Receveur extra-plat\n(pose rapide, 150-600€)"]
    B --> E["Receveur à carreler\n(rendu sur-mesure, 300-800€)"]
    C --> F["Receveur encastré\n(effet plain-pied, 400-1500€)"]
    C --> G["Chape + étanchéité\n(max personnalisation)"]
...
```mermaid
flowchart LR
    A["Receveur extra-plat\nrésine/acrylique"]
    B["Receveur à carreler\nsupport hydrofuge"]
    C["Receveur encastré\ncomposite/résine"]

    A --> A1["Entretien : facile\nDurée : 10-15 ans\nPrix : 150-600€"]
    B --> B1["Entretien : joints à surveiller\nDurée : 20+ ans\nPrix : 300-800€ + carrelage"]
    C --> C1["Entretien : facile\nDurée : 20+ ans\nPrix : 400-1500€"]

    style A fill:#FFF0F5,stroke:#E879F9,color:#701A75
    style B fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    style C fill:#FEF3F2,stroke:#F97316,color:#9A3412
    style A1 fill:#F9FAFB,stroke:#6B7280,color:#374151

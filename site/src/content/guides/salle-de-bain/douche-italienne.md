---
title: "Douche italienne : tout savoir avant de se lancer"
description: "Douche italienne : avantages, contraintes techniques, prix et idées déco pour créer une salle de bain moderne et accessible. Guide complet."
type: guide
...
```mermaid
flowchart TD
    A["Projet douche italienne"]:::principal
    A --> B["Diagnostic plomberie"]:::secondaire
    A --> C["Choix évacuation"]:::secondaire
    B --> D["Niveau du sol actuel"]:::neutre
    B --> E["Position du siphon"]:::neutre
    C --> F["Bonde centrale"]:::secondaire
    C --> G["Caniveau linéaire"]:::secondaire
    C --> H["Bonde de coin"]:::secondaire
    F --> I["Pente 2% vers le centre"]:::accent
    G --> I2["Pente 2% vers le mur"]:::accent
    H --> I3["Pente 2% vers le coin"]:::accent
    ...
    style I2 fill:#FEF3F2,stroke:#F97316,color:#9A3412
    style I3 fill:#FEF3F2,stroke:#F97316,color:#9A3412
```
...
```mermaid
flowchart LR
    A["Budget total"]:::principal
    A --> B["Gros oeuvre\n500-2000€"]:::secondaire
    A --> C["Receveur/étanchéité\n300-800€"]:::secondaire
    A --> D["Carrelage\n300-1200€"]:::secondaire
    A --> E["Robinetterie\n200-1500€"]:::secondaire
    A --> F["Paroi/verre\n0-1200€"]:::secondaire
    A --> G["Main d'oeuvre\n1000-3000€"]:::accent

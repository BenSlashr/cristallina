---
title: "Salle de bain industrielle : comment adopter ce style brut et chic"
description: "Tuyaux apparents, béton, métal noir et bois brut : crée une salle de bain industrielle authentique avec nos idées déco et conseils pratiques."
type: guide
...
```mermaid
graph TD
    A["Salle de bain industrielle"]
    A --> B["Matières brutes"]
    A --> C["Eclairage vintage"]
    A --> D["Accessoires metal"]
    B --> E["Beton cire"]
    B --> F["Brique apparente"]
    B --> G["Bois vieillie"]
    C --> H["Ampoules filament"]
    C --> I["Appliques metal noir"]
    D --> J["Robinetterie gun metal"]
    D --> K["Tuyaux cuivre"]
...
```mermaid
flowchart LR
    A["Budget accessible\nMoins de 500€"] --> B["Robinetterie metal noir\n50-150€"]
    A --> C["Accessoires DIY\ntuyaux cuivre\n30€"]
    A --> D["Ampoules filament\n+ cable textile\n20-40€"]
    E["Budget moyen\n500-2000€"] --> F["Plan beton cire\nou meuble bois brut\n300-800€"]
    E --> G["Carrelage grand format\nimitation beton\n30-60€/m²"]
    H["Budget confort\n2000€ et plus"] --> I["Beton cire\npar professionnel"]
    H --> J["Vasque a poser\nciment ou fonte"]
    style A fill:#FFF0F5,stroke:#E879F9,color:#701A75

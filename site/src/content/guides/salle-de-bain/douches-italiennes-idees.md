---
title: "Douches italiennes : 15 idées déco pour une salle de bain moderne"
description: "15 idées pour ta douche italienne : carrelage, matériaux, tailles et budgets. Transforme ta salle de bain avec style et praticité."
type: guide
...
```mermaid
flowchart TD
    A[Format du carrelage]:::main --> B[Grand format 60x120]:::secondary
    A --> C[Moyen format 30x60]:::tertiary
    A --> D[Petits formats / mosaïque]:::neutral
    B --> E[Effet espace, peu de joints à entretenir]:::neutral
    C --> F[Polyvalent, bonne accroche]:::neutral
    D --> G[Grip naturel, adapté aux pentes]:::neutral

    classDef main fill:#FFF0F5,stroke:#E879F9,color:#701A75
    classDef secondary fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    classDef tertiary fill:#FEF3F2,stroke:#F97316,color:#9A3412
...
```mermaid
flowchart LR
    A[Type de bonde]:::main --> B[Bonde centrale]:::secondary
    A --> C[Caniveau latéral]:::tertiary
    A --> D[Caniveau mural encastré]:::secondary
    B --> E[Pente dans 4 directions - plus complexe]:::neutral
    C --> F[Pente dans 1 direction - plus simple]:::neutral
    D --> G[Invisible - intégration maximale]:::neutral
...
```mermaid
flowchart TD
    A[Quel style pour ta douche ?]:::main --> B[Minimaliste moderne]:::secondary
    A --> C[Chaleureux naturel]:::tertiary
    A --> D[Luxe discret]:::secondary
    B --> E[Grand format grès cérame neutre + caniveau inox]:::neutral
    C --> F[Zellige / travertin + accessoires teck]:::neutral
    D --> G[Marbre / imitation marbre + robinetterie noire mate]:::neutral

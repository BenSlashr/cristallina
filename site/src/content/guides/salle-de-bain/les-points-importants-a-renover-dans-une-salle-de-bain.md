---
title: "Rénovation salle de bain : les points importants à ne pas négliger"
description: "Les points clés pour rénover ta salle de bain sans mauvaises surprises : ventilation, plomberie, éclairage, matériaux et budget concret."
type: guide
...
```mermaid
flowchart TD
    A["Rénovation plomberie"]:::main --> B["Diagnostic\ncanalisations"]:::second
    A --> C["Évacuation"]:::second
    A --> D["Production\neau chaude"]:::second
    B --> E["Cuivre OK ?\nPlomb à remplacer"]:::neutral
    C --> F["Diamètre 50 mm min\nPente 1 cm/m"]:::neutral
    D --> G["Cumulus classique\nvs thermodynamique"]:::neutral
    G --> H["Économies\n50 à 70 %"]:::accent

    classDef main fill:#FFF0F5,stroke:#E879F9,color:#701A75
    classDef second fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
...
```mermaid
flowchart LR
    A["Budget rénovation\nsalle de bain"]:::main --> B["Petit budget\n3 000 - 5 000 euros"]:::second
    A --> C["Budget moyen\n5 000 - 10 000 euros"]:::second
    A --> D["Grand budget\n10 000 - 20 000 euros"]:::accent
    B --> E["- Rafraîchissement\n- Peinture + accessoires\n- Robinetterie neuve"]:::neutral
    C --> F["- Nouveau carrelage\n- Meuble vasque\n- Douche italienne"]:::neutral
    D --> G["- Rénovation complète\n- Déplacement plomberie\n- Matériaux nobles"]:::neutral

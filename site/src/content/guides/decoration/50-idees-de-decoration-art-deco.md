---
title: "Décoration Art Déco : 50 idées pour un intérieur glamour et géométrique"
description: "Découvre 50 idées de décoration Art Déco pour ton intérieur : motifs géométriques, couleurs audacieuses, matériaux luxueux et accessoires chic."
type: guide
branch: decoration
parent: decoration
order: 5
...
```mermaid
flowchart TD
    A["Style Art Déco"]:::principal
    A --> B["Formes géométriques\nChevrons, éventails, zigzags"]:::secondaire
    A --> C["Matériaux nobles\nLaiton, marbre, velours"]:::secondaire
    A --> D["Couleurs contrastées\nNoir, or, émeraude, bordeaux"]:::accent
    B --> E["Symétrie stricte"]:::neutre
    C --> F["Textures riches"]:::neutre
    D --> G["Glamour immédiat"]:::neutre
...
```mermaid
flowchart LR
    A["Textiles Art Déco"]:::principal
    A --> B["Velours\nCanapé, rideaux, coussins"]:::secondaire
    A --> C["Satin et soie\nLinge de lit, accessoires"]:::secondaire
    A --> D["Fausse fourrure\nPlaids, jetés"]:::accent
    B --> E["Couleurs profondes\nÉmeraude, bordeaux"]:::neutre
    C --> F["Reflets lumineux"]:::neutre
    D --> G["Texture luxueuse"]:::neutre
...
```mermaid
flowchart TD
    A["Art Déco +\nautres styles"]:::principal
    A --> B["+ Minimaliste\nPièces fortes\nsur fond épuré"]:::secondaire
    A --> C["+ Contemporain\nCaractère ajouté\nau moderne"]:::secondaire
    A --> D["+ Hollywood Regency\nGlamour assumé"]:::accent
    A --> E["Éviter : bohème\nrustique, campagnard"]:::neutre

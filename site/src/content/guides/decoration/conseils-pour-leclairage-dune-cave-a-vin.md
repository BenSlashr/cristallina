---
title: "Éclairage cave à vin : conseils pour illuminer sans abîmer tes bouteilles"
description: "Quel éclairage pour une cave à vin ? LED, intensité, placement : tous nos conseils pour éclairer ta cave sans altérer la qualité du vin."
type: guide
branch: decoration
parent: decoration
order: 8
...
```mermaid
flowchart TD
    A["Choisir l'éclairage\nde ta cave"] --> B["LED"]
    A --> C["Halogène"]
    A --> D["Incandescent"]
    A --> E["Néon / Fluocompact"]
    ...
    style D1 fill:#141D30,stroke:#8B5CF6,color:#F1F5F9
    style E1 fill:#141D30,stroke:#8B5CF6,color:#F1F5F9
    style F fill:#141D30,stroke:#10B981,color:#F1F5F9
    style G fill:#141D30,stroke:#EF4444,color:#F1F5F9
```
...
flowchart LR
    ...
    style F fill:#141D30,stroke:#10B981,color:#F1F5F9
    style G fill:#141D30,stroke:#10B981,color:#F1F5F9
```

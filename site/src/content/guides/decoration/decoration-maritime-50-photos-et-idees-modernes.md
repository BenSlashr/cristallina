---
title: "Décoration maritime : 50 photos et idées modernes pour un intérieur bord de mer"
description: "Adopte la déco maritime moderne chez toi : couleurs bleu et sable, matériaux naturels, objets marins, meubles côtiers. Photos, prix et astuces concrètes."
type: guide
branch: decoration
parent: decoration
order: 6
...
```mermaid
flowchart TD
    A["Palette maritime moderne"]
    A --> B["Base neutre 60%\nBlanc écru, sable, gris galet"]
    A --> C["Bleus 30%\nMarine, céladon, turquoise doux"]
    A --> D["Accents naturels 10%\nBois flotté, corde, terracotta"]
    B --> E["Murs, sols\nGros meubles"]
    C --> F["Textiles, coussins\nObjets déco"]
    D --> G["Petites touches\nDétails artisanaux"]
...
flowchart LR
    ...
    A --> D["Salle de bains\nDosage moyen"]
    A --> E["Terrasse\nDosage libre"]
    B --> B1["Canapé lin + tapis jute\nCoussins bleus + miroir hublot"]
    C --> C1["Lin lavé bleu pâle\nTête de lit bois flotté"]
    D --> D1["Meuble teck + galets\nMiroir hublot + plantes"]
    E --> E1["Mobilier teck ou métal\nLanternes + canisses"]
    ...
    style E1 fill:#FEF3F2,stroke:#F97316,color:#9A3412
```
...
flowchart TD
    A["Style maritime"]
    A --> B["Moderne - Hampton"]
    A --> C["Vintage - Port de pêche"]
    B --> B1["Lignes épurées\nBois peint blanc"]
    B --> B2["Palette douce\nBleu-gris + blanc"]
    B --> B3["Meubles neufs\nDesign côtier"]
    C --> C1["Bois patiné\nObjets chinés"]
    C --> C2["Palette affirmée\nBleu marine + bois brut"]
    C --> C3["Pièces de bateau\nAuthentiques"]

---
title: "Tapis imprimé : comment choisir le motif parfait pour chaque pièce"
description: "Tapis imprimé, géométrique ou floral : guide complet pour choisir le bon motif, la bonne taille et la matière adaptée à chaque pièce de ta maison."
type: guide
branch: decoration
parent: decoration
order: 6
...
```mermaid
graph TD
    A["Choisir ton motif"]:::principal
    A --> B["Géométrique"]:::secondaire
    A --> C["Floral"]:::secondaire
    A --> D["Abstrait"]:::secondaire
    A --> E["Ethnique / Kilim"]:::secondaire
    B --> F["Effet : structure, ordre,\nmodernité"]:::neutre
    C --> G["Effet : douceur,\nféminité, nature"]:::neutre
    D --> H["Effet : art contemporain,\noriginalité"]:::neutre
    E --> I["Effet : chaleur,\nvoyage, caractère"]:::neutre
...
```mermaid
flowchart LR
    A["Zone de la maison"]:::principal
    A --> B["Salon / Chambre"]:::secondaire
    A --> C["Entrée / Couloir"]:::secondaire
    A --> D["Cuisine / Salle à manger"]:::secondaire
    A --> E["Chambre d'enfant"]:::secondaire
    B --> F["Laine ou coton épais\nBudget : 150-400 euros"]:::neutre
    C --> G["Polypropylène ou coton ras\nBudget : 30-100 euros"]:::neutre
    D --> H["Polypropylène ou tissé plat\nBudget : 50-200 euros"]:::neutre
    E --> I["Coton lavable en machine\nBudget : 40-120 euros"]:::neutre
...
```mermaid
graph TD
    A["Ta pièce est plutôt..."]:::principal
    A --> B["Sobre / Neutre\nMurs blancs, meubles simples"]:::secondaire
    A --> C["Déjà décorée\nTableaux, plantes, motifs"]:::secondaire
    B --> D["Tu peux oser :\nMotif coloré et complexe"]:::accent
    C --> E["Reste discret :\n2 couleurs, motif espacé"]:::neutre

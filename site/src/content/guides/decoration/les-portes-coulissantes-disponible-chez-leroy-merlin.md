---
title: "Portes coulissantes Leroy Merlin : guide complet pour bien choisir"
description: "Porte coulissante Leroy Merlin : types, prix, dimensions et conseils de pose. Tout pour choisir entre rail, galandage et placard coulissant."
type: guide
branch: decoration
parent: decoration
order: 3
image: "/images/guides/les-portes-coulissantes-disponible-chez-leroy-merlin.webp"
readingTime: "11 min"
faqSchema: true
pubDate: 2026-02-17
---
...
```mermaid
flowchart TD
    A[Tu veux une porte coulissante] --> B{Quel type de projet ?}
    B -- Séparer 2 pièces --> C{Budget travaux ?}
    B -- Fermer un placard --> D[Porte de placard\ncoulissante 120-600 EUR]
    C -- Petit budget\npas de gros travaux --> E[Porte en applique\n80-450 EUR]
    C -- Budget moyen\ntravaux OK --> F[Porte à galandage\n400-1200 EUR]
    E --> G{Besoin de lumière ?}
    F --> G
    G -- Oui --> H[Version vitrée\n+100-200 EUR]
    G -- Non --> I[Version pleine\nbois ou MDF]

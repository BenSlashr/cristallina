---
title: "Couleurs du salon 2026 : palettes de murs et de decors"
description: "Teal, olive, blanc chaud, terracotta... Decouvre les palettes couleurs salon tendance 2026 pour transformer ta piece principale avec style."
type: guide
branch: decoration
parent: decoration
order: 8
...
graph TD
    ...
    B["Blanc chaud\n(autres murs)"]:::secondaire
    C["Lin naturel\n(canapé, rideaux)"]:::neutre
    D["Cuivre ou laiton\n(accessoires)"]:::accent
...
flowchart LR
    ...
    L2["Salon au nord\nou peu lumineux"]:::accent --> R2["Blanc chaud, ivoire,\nbeige rosé à favoriser"]:::neutre
    L3["Salon mixte\nou lumière indirecte"]:::principal --> R3["Olive doux ou teal\nsur un seul mur"]:::secondaire
...
```mermaid
graph LR
    E1["1. Analyse\nla lumiere"]:::principal --> E2["2. Choisis\nta palette"]:::secondaire --> E3["3. Teste\nun echantillon"]:::accent --> E4["4. Peins\nle mur accent"]:::neutre --> E5["5. Ajoute\nles accessoires"]:::principal

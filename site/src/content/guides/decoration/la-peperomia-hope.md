---
title: "Peperomia Hope entretien : le guide complet pour une plante au top"
description: "Tout savoir sur l'entretien du Peperomia Hope : arrosage, lumiere, bouturage, rempotage et erreurs a eviter pour garder cette plante retombante en pleine forme."
type: guide
branch: decoration
parent: decoration
order: 8
...
```mermaid
flowchart TD
    A["Tu veux arroser ton Peperomia ?"]
    A --> B["Enfonce ton doigt\nsur 2-3 cm"]
    B --> C{"Substrat sec ?"}
    C -->|Oui| D["Arrose copieusement\njusqu'au drainage"]
    C -->|Non| E["Attends 2-3 jours\net reteste"]
    D --> F["Vide la soucoupe\napres 15 min"]
    E --> B
...
```mermaid
flowchart LR
    A["Bouture tige\n8-10 cm"] --> B["Retirer feuilles\ndu bas"]
    B --> C["Secher 2-3h\na l'air"]
    C --> D{"Dans l'eau\nou substrat ?"}
    D -->|Eau| E["Changer eau\ntous les 3-4j"]
    D -->|Substrat| F["Garder humide\nsans detremper"]
    E --> G["Racines en\n2-4 semaines"]
    F --> G
    G --> H["Rempoter quand\nracines 2-3 cm"]

---
title: "Comment verrouiller une porte intérieure : guide complet et solutions pratiques"
description: "Découvre toutes les solutions pour verrouiller une porte intérieure : verrou à bouton, serrure à clé, loquet, et astuces sans percer. Prix, marques et tutos."
type: guide
branch: decoration
parent: decoration
order: 3
...
graph TD
    ...
    A --> C["Sécuriser la pièce"]
    A --> D["Solution temporaire"]

    B --> E["Verrou à bouton<br/>5-20 euros"]
    B --> F["Loquet<br/>8-30 euros"]

    C --> G["Verrou à clé<br/>15-45 euros"]
    C --> H["Serrure encastrée<br/>20-60 euros"]

    D --> I["Cale de porte<br/>3-15 euros"]
    D --> J["Verrou portable<br/>10-25 euros"]
...
```mermaid
graph LR
    A["Porte coulissante"] --> B{"Type de pose ?"}
    B --> C["Apparente<br/>(rail visible)"]
    B --> D["À galandage<br/>(dans le mur)"]

    C --> E["Verrou à crochet<br/>5-10 euros"]
    C --> F["Serrure flush<br/>15-25 euros"]

    D --> G["Serrure encastrée<br/>30-55 euros"]
    D --> H["Kit verrouillage<br/>Mantion / Éclisse"]

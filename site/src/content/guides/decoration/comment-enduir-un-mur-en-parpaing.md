---
title: "Enduire un mur en parpaing : guide complet pour un rendu impeccable"
description: "Comment enduire un mur en parpaing soi-même : préparation, choix de l'enduit, application couche par couche. Toutes les étapes pour un résultat pro."
type: guide
branch: decoration
parent: decoration
order: 2
...
```mermaid
graph TD
    A[Mur en parpaing brut] --> B[Préparation du support]
    B --> C[Humidification]
    C --> D[Gobetis - couche d'accroche]
    D --> E[Corps d'enduit]
    E --> F[Finition / lissage]
    F --> G[Séchage 28 jours]
    G --> H[Peinture ou décoration]
...
```mermaid
graph LR
    A[Gobetis 3-5mm] --> B[Corps d'enduit 8-12mm]
    B --> C{Rendu souhaité}
    C -->|Lisse| D[Couche de finition + lissage]
    C -->|Texturé| E[Talochage / crépi]
    C -->|Rustique| F[Laisser tel quel]

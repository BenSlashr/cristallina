---
title: "Crépir un mur intérieur : guide complet pour un résultat pro"
description: "Comment crépir un mur intérieur étape par étape : préparation, choix du crépi, application et finitions. Tous les conseils pour un résultat impeccable."
type: guide
branch: decoration
parent: decoration
order: 5
...
flowchart TD
    ...
    B["Appliquer la sous-couche\nd'accrochage"]
    C["Préparer le crépi\n(mélange ou remise en pâte)"]
    D["Appliquer le crépi\nen commençant par le haut"]
    E["Créer la texture\n(taloche, rouleau)"]
    F["Laisser sécher\n24 à 48h"]
    G["Peindre ou finir\nsi souhaité"]
...
flowchart LR
    ...
    D["DIY possible\nBudget : 30-60€/10m²"]
    E["Artisan recommandé\nBudget : 25-45€/m²"]

    F["Résultat satisfaisant\nen 1 journée de travail"]
    G["Résultat pro\ngarantie décennale"]

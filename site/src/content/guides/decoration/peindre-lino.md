---
title: "Peindre du lino : guide pratique pour un sol transformé sans gros travaux"
description: "Comment peindre un sol en lino étape par étape ? Produits adaptés, préparation, application et entretien : tout pour réussir ta peinture sur linoleum."
type: guide
branch: decoration
parent: decoration
order: 9
...
```mermaid
graph TD
    A["Nettoyage complet du lino"] --> B["Séchage 24h minimum"]
    B --> C["Ponçage léger grain 120-180"]
    C --> D["Aspiration des poussières"]
    D --> E["Application du primaire"]
    E --> F["Séchage 4-6h"]
    F --> G["1ère couche de peinture"]
    G --> H["Séchage selon produit"]
    H --> I["2ème couche de peinture"]
    I --> J["Vernis de protection optionnel"]
...
```mermaid
graph LR
    A["Primaire<br/>15-22 euros"] --> B["Peinture sol<br/>35-55 euros"]
    B --> C["Vernis protection<br/>25-35 euros"]
    C --> D["Matériel<br/>15-25 euros"]
    D --> E["Total<br/>90-137 euros"]
    style A fill:#FFF0F5,stroke:#E879F9,color:#701A75

---
title: "Coussins décoratifs : guide pour habiller salon, fauteuil et sol"
description: "Comment choisir tes coussins décoratifs pour le salon, le fauteuil ou le sol. Matières, tailles, styles et bons plans pour un intérieur cosy."
type: guide
branch: decoration
parent: decoration
order: 4
...
```mermaid
graph TD
    A["Choisir la bonne matière"]:::principal
    A --> B["Lin\nNaturel, froissé-chic"]:::secondaire
    A --> C["Velours\nCosy, lumineux"]:::secondaire
    A --> D["Coton tissé\nRésistant, versatile"]:::secondaire
    A --> E["Jute/Chanvre\nBrut, bohème"]:::secondaire

    B --> F["Salon, chambre"]:::neutre
    C --> G["Salon, fauteuil"]:::neutre
    D --> H["Partout"]:::neutre
    E --> I["Coussins de sol"]:::neutre
...
```mermaid
flowchart LR
    A["Coussins de sol"]:::principal
    A --> B["Pouf rond\n50-70 cm\n25-60 euros"]:::secondaire
    A --> C["Coussin plat XXL\n70-80 cm\n20-50 euros"]:::secondaire
    A --> D["Zabuton\n50x50 cm\nDès 15 euros"]:::secondaire

    B --> E["Salon convivial"]:::neutre
    C --> F["Coin lounge"]:::neutre
    D --> G["Méditation, lecture"]:::neutre
...
```mermaid
graph TD
    A["Entretien coussins"]:::principal
    A --> B["Housses\nLavage 30-40 degrés\n1x par mois"]:::secondaire
    A --> C["Garnissage\nSecouer 1x par semaine\nRegarnir si besoin"]:::secondaire
    A --> D["Protection\nTourner régulièrement\nÉviter soleil direct"]:::secondaire

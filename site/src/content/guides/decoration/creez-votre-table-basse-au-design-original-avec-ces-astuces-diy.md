---
title: "Table basse DIY : 6 idées originales pour la fabriquer toi-même"
description: "Fabrique ta table basse originale avec ces astuces DIY. Palettes, bois massif, pieds design - guide complet avec prix, étapes et conseils pratiques."
type: guide
branch: decoration
parent: decoration
order: 4
...
```mermaid
flowchart TD
    A[Choix du style]:::principal
    B[Pieds en épingle\nMid-century / Scandinave]:::secondaire
    C[Pieds fer plat\nIndustriel / Loft]:::secondaire
    D[Roulettes\nRécup / Factory]:::secondaire
    E[Pieds en bois\nNaturel / Bohème]:::secondaire
...
```mermaid
flowchart LR
    A[Palette\n15-30 euros]:::principal --> B[Chêne + hairpin\n80-130 euros]:::secondaire
    B --> C[Touret\n20-60 euros]:::principal
    C --> D[Caisses de vin\n10-30 euros]:::secondaire
    D --> E[Béton + bois\n50-100 euros]:::principal
    E --> F[Porte ancienne\n30-80 euros]:::secondaire
...
```mermaid
flowchart TD
    A[Erreur courante]:::principal
    B[Bois non traité\nRisque : moisissures]:::secondaire
    C[Pas de patins\nRisque : sol rayé]:::secondaire
    D[Plateau trop fin\nRisque : déformation]:::secondaire
    E[Pas de pré-perçage\nRisque : bois éclaté]:::secondaire

---
title: "Chaise de salon : comment choisir l'assise parfaite"
description: "Fauteuil, chaise longue ou chaise design ? Guide complet pour choisir la chaise de salon idéale selon ton style, ton confort et ton budget."
type: guide
branch: decoration
parent: decoration
order: 8
...
```mermaid
flowchart TD
    A["Choisir son assise de salon"]:::principal
    A --> B["Fauteuil"]:::secondaire
    A --> C["Chaise design"]:::secondaire
    A --> D["Chaise longue"]:::secondaire
    B --> E["Confort max\nDossier haut, accoudoirs\n100 - 1 200 euros"]:::principal
    C --> F["Polyvalence\nLégère, empilable\n80 - 400 euros"]:::principal
    D --> G["Détente totale\nJambes allongées\n350 - 8 000 euros"]:::principal
...
```mermaid
flowchart LR
    A["Ton style déco"]:::principal --> B["Scandinave"]:::secondaire
    A --> C["Industriel"]:::secondaire
    A --> D["Bohème"]:::secondaire
    A --> E["Minimaliste"]:::secondaire
    B --> F["Bois clair + tissu doux\nHAY, IKEA, Muuto"]:::principal
    C --> G["Métal + cuir vieilli\nTolix, Riveted"]:::principal
    D --> H["Rotin + motifs ethniques\nMaisons du Monde"]:::principal
    E --> I["Formes pures + neutres\nKartell, Hay"]:::principal

---
title: "Choisir un tableau mural : le guide pour trouver celui qui te correspond"
description: "Comment choisir un tableau mural adapté à ton intérieur ? Taille, style, couleurs, placement : toutes les clés pour un mur qui a du caractère."
type: guide
branch: decoration
parent: decoration
order: 10
...
```mermaid
flowchart TD
    A["Choisir la taille du tableau"]:::principal
    A --> B["Mesure le mur\net le meuble dessous"]:::secondaire
    B --> C["Règle des 2/3\nLargeur tableau = 60-75% du meuble"]:::principal
    A --> D["Hauteur d'accrochage"]:::secondaire
    D --> E["Centre à 145-150 cm du sol\nOu 15-25 cm au-dessus du meuble"]:::principal
    A --> F["Solo ou composition ?"]:::secondaire
    F --> G["Grand mur = 1 pièce XXL\nou gallery wall 5-9 cadres"]:::principal
...
```mermaid
flowchart LR
    A["Type d'oeuvre"]:::principal
    A --> B["Photo d'art\n15-150 euros"]:::secondaire
    A --> C["Peinture abstraite\n10-500+ euros"]:::secondaire
    A --> D["Illustration\n10-30 euros"]:::accent
    A --> E["Oeuvre textile\n40-200 euros"]:::neutre
    B --> F["Sophistiqué\nPasse-partout"]:::neutre
    C --> G["Moderne\nColorée"]:::neutre
    D --> H["Personnel\nGraphique"]:::neutre
    E --> I["Texture\nVolume"]:::neutre

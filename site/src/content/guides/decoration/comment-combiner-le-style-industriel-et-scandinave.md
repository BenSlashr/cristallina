---
title: "Style industriel et scandinave : comment les combiner avec succès"
description: "Découvre comment mixer le style industriel et scandinave pour un intérieur unique. Métal, bois clair et lumière pour un duo déco au top."
type: guide
branch: decoration
parent: decoration
order: 10
...
```mermaid
graph TD
    A["Palette de base"] --> B["Blanc / Crème - 60%"]
    A --> C["Bois clair / Beige - 30%"]
    A --> D["Noir / Métal - 10%"]
    B --> E["Murs, plafonds, grands meubles"]
    C --> F["Parquet, étagères, textiles"]
    D --> G["Luminaires, pieds, cadres"]
...
```mermaid
flowchart LR
    A["Éclairage scandi-indus"] --> B["Lumière naturelle"]
    A --> C["Suspensions métal"]
    A --> D["Lampes d'appoint"]
    B --> B1["Verrières, stores lin, fenêtres dégagées"]
    C --> C1["Métal noir, laiton, ampoules filament"]
    D --> D1["Bois, céramique, lumière chaude"]
    style A fill:#FFF0F5,stroke:#E879F9,color:#701A75
    style B fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    style C fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    style D fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
...
```mermaid
graph TD
    A["Budget scandi-indus"] --> B["Petit budget - moins de 500 euros"]
    A --> C["Budget moyen - 500 à 1500 euros"]
    A --> D["Budget confort - 1500 à 3000 euros"]
    B --> B1["Suspensions métal + coussins lin + plantes"]
    C --> C1["Table bois/métal + étagères + luminaires"]
    D --> D1["Verrière + parquet chêne + mobilier complet"]
    style A fill:#FFF0F5,stroke:#E879F9,color:#701A75
    style B fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    style C fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    style D fill:#F3F4F6,stroke:#8B5CF6,color:#581C87

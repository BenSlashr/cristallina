---
title: "Fleurs en tissu ou en papier : tuto pas à pas pour des créations bluffantes"
description: "Apprends à créer de belles fleurs en tissu ou en papier avec ce guide détaillé. Matériaux, étapes et astuces pour des décorations maison originales."
type: guide
branch: decoration
parent: decoration
order: 7
...
```mermaid
flowchart TD
    A["Couper des bandes de crépon\n5 cm x 30 cm"] --> B["Froisser légèrement\npour texturer"]
    B --> C["Enrouler la première bande\nautour de l'étamine"]
    C --> D["Ajouter les bandes suivantes\nen évasant progressivement"]
    D --> E["Fixer avec du ruban fleuriste\nautour de la base"]
    E --> F["Fixer sur une tige\nen fil de fer"]
...
```mermaid
flowchart LR
    A["Tracer et découper\nles pétales (x6 à x8)"] --> B["Superposer les pétales\ndu plus grand au plus petit"]
    B --> C["Coudre ou coller\nau centre"]
    C --> D["Ajouter un bouton\nou des perles au centre"]
    D --> E["Coller sur une épingle\nou un barrette"]

---
title: "Pistolet à calfeutrer : guide complet pour bien choisir et bien l'utiliser"
description: "Manuel, électrique ou pro ? Découvre comment choisir ton pistolet à calfeutrer et réussir tes joints comme un pro. Guide pratique complet."
type: guide
branch: decoration
parent: decoration
order: 6
...
```mermaid
graph TD
    A[Quel pistolet choisir ?] --> B{Volume de joints}
    B -->|Petit - 1 à 3 cartouches/an| C[Manuel classique]
    B -->|Moyen - 5 à 15 cartouches| D[Manuel renforcé ratio 18:1]
    B -->|Important - 15+ cartouches| E[Electrique sans fil]
    B -->|Pro quotidien| F[Pneumatique]
    C --> G[Budget : 5-10 euros]
    D --> H[Budget : 15-25 euros]
    E --> I[Budget : 80-200 euros]
    F --> J[Budget : 150-400 euros]
    ...
    style J fill:#141D30,stroke:#8B5CF6,color:#F1F5F9
```
...
```mermaid
graph LR
    A[Couper l'embout en biseau] --> B[Percer la membrane]
    B --> C[Scotch de masquage]
    C --> D[Appliquer le cordon à 45 degrés]
    D --> E[Lisser au doigt mouillé]
    E --> F[Retirer le scotch immédiatement]

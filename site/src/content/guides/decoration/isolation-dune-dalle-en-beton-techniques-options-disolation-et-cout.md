---
title: "Isolation dalle béton : techniques, matériaux et coût au m²"
description: "Comment isoler une dalle en béton ? Sous-dalle, par dessus ou en sous-face : compare les techniques, matériaux et prix pour ton projet."
type: guide
branch: decoration
parent: decoration
order: 7
...
```mermaid
graph TD
    A["Terrain decaisse et compacte"] --> B["Film polyane anti-humidite"]
    B --> C["Panneaux isolants rigides"]
    C --> D["Treillis soude"]
    D --> E["Coulage dalle beton"]
    E --> F["Revetement de sol"]
...
```mermaid
graph LR
    A["Dalle beton existante"] --> B{"Acces par dessous ?"}
    B -->|"Cave / garage"| C["Panneaux colles ou chevilles"]
    B -->|"Vide sanitaire"| D["Flocage ou panneaux sur suspentes"]
    B -->|"Pas d acces"| E["Isolation par dessus"]
    C --> F["XPS / PUR / Laine de roche"]
    D --> G["Laine minerale soufflee"]

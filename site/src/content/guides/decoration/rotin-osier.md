---
title: "Rotin et osier : différences, entretien et idées déco pour ta maison"
description: "Rotin ou osier ? Découvre les différences, nos conseils d'entretien et 10 idées déco pour intégrer ces matières naturelles chez toi."
type: guide
branch: decoration
parent: decoration
order: 10
image: "/images/guides/rotin-osier.webp"
readingTime: "10 min"
faqSchema: true
pubDate: 2026-02-17
---
...
```mermaid
flowchart TD
    A["Matière naturelle ?"] --> B["Structure pleine,\nsouple, courbable ?"]
    A --> C["Tiges fines,\nvannerie ?"]
    A --> D["Tige creuse,\nrigide, droite ?"]
    A --> E["Fibre de feuille,\ntressage fin ?"]
    B --> F["ROTIN\nMeubles, structures"]
    C --> G["OSIER\nPaniers, accessoires"]
    D --> H["BAMBOU\nEtagères, cadres"]
    E --> I["RAPHIA\nHabillage, tressage"]
...
```mermaid
flowchart LR
    A["Salon"] --> B["Fauteuil rotin\nTable basse rotin/verre\nPaniers rangement"]
    C["Chambre"] --> D["Tete de lit cannage\nLampe de chevet osier\nCorbeille tressée"]
    E["Salle de bain"] --> F["Miroir osier\nPaniers rangement\nCorbeille a linge"]
    G["Cuisine/Salle\na manger"] --> H["Chaises cannage\nSuspension rotin\nCorbeille a pain"]

---
title: "Bleu salon : comment adopter cette couleur star en déco"
description: "Du bleu canard au bleu nuit, découvre comment intégrer le bleu dans ton salon. Associations, nuances et erreurs à éviter pour un résultat au top."
type: guide
branch: decoration
parent: decoration
order: 5
...
```mermaid
graph TD
    A["Choisir sa nuance de bleu"]:::principal --> B["Petit salon\n< 15 m2"]:::secondaire
    A --> C["Grand salon\n> 20 m2"]:::secondaire
    A --> D["Luminosité\nmoyenne"]:::secondaire

    B --> E["Bleu pastel\nBleu ciel"]:::principal
    C --> F["Bleu nuit\nBleu canard"]:::principal
...
```mermaid
graph LR
    A["Bleu canard"]:::principal --> B["+ Blanc cassé\nFrais et lumineux"]:::secondaire
    A --> C["+ Bois clair\nChaleureux et nordique"]:::secondaire
    A --> D["+ Doré / Laiton\nChic et art déco"]:::secondaire
    A --> E["+ Terracotta\nAudacieux et moderne"]:::secondaire
...
```mermaid
graph TD
    A["Le bleu selon ton style"]:::principal
    A --> B["Scandinave"]:::secondaire
    A --> C["Bord de mer"]:::secondaire
    A --> D["Art Déco"]:::secondaire

    B --> E["Bleu pastel + bois clair\n+ blanc + lin"]:::principal
    C --> F["Bleu marine + blanc\n+ bois flotté + corde"]:::principal
    D --> G["Bleu nuit + doré\n+ velours + géométrique"]:::principal

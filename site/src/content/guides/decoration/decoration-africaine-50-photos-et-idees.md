---
title: "Décoration africaine : 50 photos et idées pour un intérieur vibrant"
description: "Découvre comment intégrer la déco africaine chez toi : couleurs chaudes, matériaux naturels, masques, paniers tressés, textiles wax. Photos et conseils."
type: guide
branch: decoration
parent: decoration
order: 7
...
flowchart TD
    A["Palette africaine"]
    A --> B["Base chaude\nOcre, terracotta, brun"]
    A --> C["Accents colorés\nRouge, safran, vert kaki"]
    A --> D["Contrastes\nNoir, blanc cassé"]
    B --> E["Murs, grands meubles\nTextiles principaux"]
    C --> F["Coussins, vases\nPetits objets"]
    D --> G["Motifs, cadres\nSculptures"]
...
```mermaid
flowchart LR
    A["Textiles africains"]
    A --> B["Wax\nMotifs colorés\nCoussins, rideaux"]
    A --> C["Bogolan\nMotifs géométriques\nJetés, plaids"]
    A --> D["Kente\nTissé main\nDécoration murale"]
    B --> E["Ambiance colorée\net joyeuse"]
    C --> F["Ambiance épurée\net chic"]
    D --> G["Pièce statement\nfort impact"]

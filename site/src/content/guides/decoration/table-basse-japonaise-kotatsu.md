---
title: "Table basse japonaise kotatsu : le meuble cosy qui change tout"
description: "Découvre le kotatsu, la table basse chauffante japonaise qui rend chaque soirée d'hiver irrésistible. Guide complet, prix et conseils déco."
type: guide
branch: decoration
parent: decoration
order: 2
image: "/images/guides/table-basse-japonaise-kotatsu.webp"
readingTime: "9 min"
faqSchema: true
pubDate: 2026-02-17
---
...
```mermaid
flowchart TD
    A[Plateau supérieur\nSurface utile]:::principal
    B[Couverture kake-futon\nRetient la chaleur]:::secondaire
    C[Cadre en bois\nStructure de la table]:::neutre
    D[Élément chauffant\nFixé sous le cadre]:::accent
...
```mermaid
graph LR
    A[Ton besoin]:::neutre --> B{Appartement\npetit espace ?}:::secondaire
    B -- Oui --> C[Modèle pliant\n60-70 cm]:::accent
    B -- Non --> D{Famille ou\nambiance salon ?}:::secondaire
    D -- Salon cosy --> E[Fixe 70-75 cm\nStyle naturel]:::principal
    D -- Famille --> F[Grand format\n80-90 cm]:::principal

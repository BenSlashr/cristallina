---
title: "Pneus recyclés pour la déco : idées créatives pour intérieur et jardin"
description: "Transforme tes vieux pneus en déco originale ! Jardin, salon, chambre : toutes les idées DIY pour recycler avec style et sans dépenser une fortune."
type: guide
branch: decoration
parent: decoration
order: 8
...
```mermaid
flowchart TD
    A["Pneu nettoyé et séché"]:::principal --> B["Ponçage + sous-couche"]:::secondaire
    B --> C{"Quel projet ?"}:::neutre
    C --> D["Table basse\n(plateau bois/verre)"]:::principal
    C --> E["Pouf\n(rembourrage + tissu)"]:::principal
    C --> F["Jardinière\n(peinture + terre)"]:::accent
    D --> G["Colle néoprène\n+ fixation plateau"]:::secondaire
    E --> H["Mousse + Sangle\n+ Housse tissu"]:::secondaire
    F --> I["Géotextile intérieur\n+ terreau"]:::accent
...
```mermaid
graph LR
    A["Jardinière pneu"]:::principal
    A --> B["Au sol\nfleurs + herbes"]:::secondaire
    A --> C["Suspendue\nmur + crochets"]:::accent
    A --> D["Empilée\npotager vertical"]:::secondaire

    B --> E["Terreau + géotextile\nDrainage via jante"]:::neutre
    C --> F["Pneu vélo/moto\nPoidsléger"]:::neutre
    D --> G["3 pneus\ndiamètres décroissants"]:::neutre

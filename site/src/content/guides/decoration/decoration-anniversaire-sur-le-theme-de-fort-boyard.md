---
title: "Décoration anniversaire Fort Boyard : idées, DIY et organisation complète"
description: "Organise un anniversaire Fort Boyard inoubliable : déco DIY, épreuves, table, invitations et budget - tout ce qu'il faut savoir."
type: guide
branch: decoration
parent: decoration
order: 5
...
```mermaid
flowchart TD
    A["Décoration Fort Boyard"]:::main --> B["Entrée / Accueil"]:::secondary
    A --> C["Espace jeux"]:::accent
    A --> D["Table goûter"]:::neutral
    B --> E["Banderole bienvenue\nTorches LED\nAffiche portrait"]:::secondary
    C --> F["Panneaux épreuves\nFilets déco\nCoffre trésor"]:::accent
    D --> G["Ballons or/noir\nGâteau thème\nVaisselle dorée"]:::neutral
...
flowchart LR
    A["Épreuves\nFort Boyard"]:::main
    A --> B["Physiques"]:::accent
    A --> C["Mentales"]:::secondary
    B --> D["Ramper sous\nles obstacles"]:::accent
    B --> E["Transporter\nl'oeuf sur\nla cuillère"]:::accent
    C --> F["Énigmes\ndu Père Fouras"]:::secondary
    C --> G["Déchiffrer\nun code secret"]:::secondary
    A --> H["Clé gagnée\n= accès au trésor"]:::neutral
...
```mermaid
timeline
    title Organisation d'un anniversaire Fort Boyard
    section 3 semaines avant
        Invitations envoyées : Kit L'Imaginarium ou boutique
        Réservation prestataire : Si animation Festimini
    section 2 semaines avant
        Commande déco : Torches, filets, vaisselle
        Impression DIY : Affiches, diplômes, photobooth
    section 1 semaine avant
        Préparation épreuves : Matériel, énigmes, lots
        Commande gâteau : Chez le boulanger
    section Jour J
        Installation salle : 2h avant les invités
        Accueil et épreuves : La fête commence !
```

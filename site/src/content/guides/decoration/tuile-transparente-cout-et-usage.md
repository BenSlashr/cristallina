---
title: "Tuile transparente : prix, pose et usages pour éclairer naturellement"
description: "Tuile transparente : types (verre, polycarbonate), prix de 8 à 60 €/m2, usages en toiture et véranda, conseils de pose et d'entretien."
type: guide
branch: decoration
parent: decoration
order: 5
...
flowchart TD
    ...
    A --> E[Avancée de toit / terrasse couverte]
    style E fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    B --> B1[Éclairage naturel sans travaux lourds]
    style B1 fill:#F9FAFB,stroke:#6B7280,color:#374151
    C --> C1[Toit vitrage partiel ou total]
    style C1 fill:#F9FAFB,stroke:#6B7280,color:#374151
    D --> D1[Réduction éclairage artificiel]
    style D1 fill:#F9FAFB,stroke:#6B7280,color:#374151
    E --> E1[Protection pluie + lumière préservée]
...
```mermaid
flowchart LR
    A[Choisir modèle compatible]
    style A fill:#FFF0F5,stroke:#E879F9,color:#701A75
    A --> B[Mesurer et commander]
    style B fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    B --> C[Déposer les tuiles existantes]
    style C fill:#F9FAFB,stroke:#6B7280,color:#374151
    C --> D[Poser les tuiles translucides]
    style D fill:#F9FAFB,stroke:#6B7280,color:#374151
    D --> E[Vérifier l'étanchéité]
    style E fill:#FEF3F2,stroke:#F97316,color:#9A3412
    E --> F[Fixer si pente > 30°]

---
title: "Tuile chatière : installation, rôle et prix pour ventiler ta toiture"
description: "Tuile chatière : comment l'installer, combien en poser, prix moyen et normes DTU. Guide complet pour ventiler ta toiture et éviter la condensation."
type: guide
branch: decoration
parent: decoration
order: 9
...
```mermaid
flowchart LR
    A[Repérage depuis les combles] --> B[Sécuriser l'accès au toit]
    style A fill:#FFF0F5,stroke:#E879F9,color:#701A75
    style B fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    B --> C[Retirer la tuile existante]
    style C fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    C --> D[Poser la chatière]
    style D fill:#FEF3F2,stroke:#F97316,color:#9A3412
    D --> E[Fixer sur le liteau]
    style E fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    E --> F["Vérifier l'étanchéité"]
...
```mermaid
flowchart TD
    A["Système de ventilation complet"]
    style A fill:#FFF0F5,stroke:#E879F9,color:#701A75
    A --> B["Entrée d'air basse : chatières + sous-face"]
    style B fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
    A --> C["Circulation : lame d'air sous tuiles"]
    style C fill:#F9FAFB,stroke:#6B7280,color:#374151
    A --> D["Sortie d'air haute : closoir ventilé"]
    style D fill:#FEF3F2,stroke:#F97316,color:#9A3412
    B --> E["Air frais entre par le bas"]
    style E fill:#F9FAFB,stroke:#6B7280,color:#374151
    C --> F["Évacuation humidité + chaleur"]
    style F fill:#F9FAFB,stroke:#6B7280,color:#374151
    D --> G["Air chaud sort par le haut"]
    style G fill:#F9FAFB,stroke:#6B7280,color:#374151
```

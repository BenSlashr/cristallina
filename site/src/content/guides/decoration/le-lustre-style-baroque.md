---
title: "Lustre baroque : comment l'intégrer dans une déco moderne"
description: "Le lustre baroque revient en force. Découvre comment choisir et intégrer un lustre à pampilles dans un intérieur contemporain sans surcharger."
type: guide
branch: decoration
parent: decoration
order: 9
...
```mermaid
graph TD
    A[Quel lustre baroque pour toi ?] --> B{Quel budget ?}
    B -->|Moins de 300 euros| C[Pampilles acrylique<br/>ou cristal entree de gamme]
    B -->|300 a 800 euros| D[Cristal qualite<br/>ou vintage chine]
    B -->|Plus de 800 euros| E[Murano, Baccarat<br/>ou piece artisanale]
    C --> F{Quel style ?}
    D --> F
    E --> F
    F -->|Classique| G[Pampilles cristal<br/>+ metal dore]
    F -->|Moderne| H[Couleur ou<br/>matiere contemporaine]
    F -->|Mixte| I[Cage bird ou<br/>baroque revisite]
...
```mermaid
flowchart LR
    A[Ampoule LED<br/>2700K blanc chaud] --> B[Variateur<br/>dimmer]
    B --> C{Nombre de bras}
    C -->|3 a 5 bras| D[5 a 7 W par ampoule<br/>Total : 15 a 35 W]
    C -->|6 a 8 bras| E[3 a 5 W par ampoule<br/>Total : 18 a 40 W]
    C -->|9 bras et plus| F[2 a 4 W par ampoule<br/>Total : 18 a 48 W]
    style A fill:#FFF0F5,stroke:#E879F9,color:#701A75
    style B fill:#F3F4F6,stroke:#8B5CF6,color:#581C87
...
```mermaid
pie title Repartition budget lustre baroque
    "Lustre" : 65
    "Ampoules LED" : 10
    "Installation electricien" : 15
    "Variateur dimmer" : 10
```

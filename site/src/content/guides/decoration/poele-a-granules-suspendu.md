---
title: "Poêle à granulés suspendu : le chauffage design qui change tout"
description: "Le poêle à granulés suspendu allie design moderne et performance. Prix, marques, installation et avantages : tout pour bien choisir ton modèle."
type: guide
branch: decoration
parent: decoration
order: 6
...
```mermaid
graph TD
    A["Réservoir de granulés<br/>(15-25 kg)"] --> B["Vis sans fin<br/>alimentation auto"]
    B --> C["Creuset de combustion<br/>allumage électrique"]
    C --> D["Ventilateur<br/>diffusion chaleur"]
    C --> E["Conduit de fumées<br/>masqué dans coffrage"]
    D --> F["Pièce chauffée<br/>rendement 80-90%"]
...
```mermaid
graph LR
    A["Budget<br/>2 000-3 000 EUR"] --> B["Invicta<br/>Aasgard"]
    C["Budget<br/>2 800-3 800 EUR"] --> D["MCZ<br/>Godin"]
    E["Budget<br/>3 800-5 000 EUR"] --> F["Stûv<br/>Seguin"]
    G["Budget<br/>5 000+ EUR"] --> H["Focus<br/>Sur mesure"]

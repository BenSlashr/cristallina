---
title: "Huile de lin sur carrelage : mode d'emploi, avantages et précautions"
description: "L'huile de lin protège et ravive les carreaux anciens. Application, séchage, entretien et erreurs à éviter : le guide complet."
type: guide
branch: decoration
parent: decoration
order: 7
...
```mermaid
flowchart TD
    A["Choisir le type d'huile de lin"]:::rose
    A --> B{"Quel est ton délai ?"}:::violet
    B --> C["Pas pressé\n(3-7 jours de séchage)"]:::neutre
    B --> D["Délai moyen\n(24-48h de séchage)"]:::neutre
    B --> E["Pressé\n(12-24h de séchage)"]:::neutre
    C --> F["Huile de lin crue\n8-12 euros/L"]:::rose
    D --> G["Huile de lin cuite\n10-15 euros/L"]:::violet
    E --> H["Huile de lin + siccatif\n10-14 euros/L"]:::violet
...
```mermaid
flowchart TD
    A["Nettoyer le carrelage\n(savon noir + séchage 24h)"]:::rose
    B["Première couche\nhuile diluée 50/50"]:::violet
    C["Essuyer le surplus\naprès 15-20 min"]:::rose
    D["Séchage\n(12h à 7 jours)"]:::violet
    E["Seconde couche\nhuile pure"]:::rose
    F["Essuyer le surplus\naprès 15-20 min"]:::violet
    G["Séchage final\n24-48h minimum"]:::rose

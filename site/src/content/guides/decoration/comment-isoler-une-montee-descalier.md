---
title: "Comment isoler une montee d'escalier : guide pratique pour garder la chaleur"
description: "Comment isoler une montee d'escalier efficacement ? Porte, rideau, panneaux isolants : toutes les solutions et budgets pour stopper les courants d'air."
type: guide
branch: decoration
parent: decoration
order: 9
...
```mermaid
graph TD
    A["Identifier la zone a isoler"] --> B["Murs de la cage d'escalier"]
    A --> C["Plafond / dessous des marches"]
    A --> D["Porte ou rideau thermique"]
    B --> E["Panneaux rigides colles"]
    B --> F["Doublage placo + laine minerale"]
    C --> G["Laine de verre ou de roche en rouleau"]
    C --> H["Panneaux polyurethane"]
    D --> I["Porte isoplane ou isotherme"]
    D --> J["Rideau thermique multicouche"]
...
```mermaid
graph LR
    A["Budget serre<br/>moins de 50 EUR"] --> B["Rideau thermique"]
    C["Budget moyen<br/>100-300 EUR"] --> D["Porte isoplane"]
    E["Investissement durable<br/>300-800 EUR"] --> F["Isolation murs + porte"]
    G["Acces combles<br/>80-400 EUR"] --> H["Trappe isolante"]

---
title: "Salons modernes et élégants 2026 : tendances, couleurs et idées déco"
description: "Quelles tendances pour ton salon en 2026 ? Couleurs, matières, meubles : tout ce qu'il faut savoir pour un intérieur moderne et élégant."
type: guide
branch: decoration
parent: decoration
order: 5
...
```mermaid
graph TD
    A[Palette salon 2026]:::main --> B[Tons chauds]:::secondary
    A --> C[Tons froids]:::secondary
    A --> D[Neutres]:::neutral
    B --> E[Ocre & argile]:::accent
    B --> F[Vert olive]:::accent
    C --> G[Bleu nuit]:::accent
    C --> H[Vert sauge]:::accent
    D --> I[Beige chaud]:::neutral
    D --> J[Crème & lin]:::neutral
...
```mermaid
flowchart LR
    A[Choisir ton style]:::main --> B{Ambiance souhaitée}:::neutral
    B --> C[Chaleureux & naturel]:::secondary
    B --> D[Moderne & épuré]:::secondary
    B --> E[Exotique & inspiré]:::secondary
    C --> F[Minimalisme wabi-sabi]:::accent
    D --> G[Bibliothèque vivante]:::accent
    E --> H[Méditerranéen contemporain]:::accent

---
title: "Salon brun : idées déco, palettes et inspirations chaleureuses"
description: "Comment décorer un salon brun avec style ? Canapés, murs, bois, velours : toutes les idées pour un intérieur chaleureux et moderne."
type: guide
branch: decoration
parent: decoration
order: 7
...
```mermaid
graph TD
    A["Famille des bruns"]:::main --> B["Bruns chauds"]:::secondary
    A --> C["Bruns froids"]:::secondary
    A --> D["Bruns dorés"]:::accent
    B --> E["Chocolat\nCognac\nCuivre"]:::main
    C --> F["Taupe\nGris-brun\nMoka"]:::neutral
    D --> G["Camel\nMiel\nAmbre"]:::accent
...
```mermaid
graph LR
    A["Brun chocolat"]:::main --> B["+ Blanc crème\n= Classique chic"]:::neutral
    A --> C["+ Vert sauge\n= Nature cosy"]:::secondary
    A --> D["+ Bleu canard\n= Moderne audacieux"]:::accent
    A --> E["+ Rose poudré\n= Douceur romantique"]:::secondary

---
title: "Matelas Emma : combien de temps avant de l'utiliser après déballage"
description: "Matelas Emma livré roulé ? Voici combien de temps tu dois attendre avant de dormir dessus et pourquoi c'est important pour ton confort."
type: guide
branch: decoration
parent: decoration
order: 3
...
```mermaid
flowchart TD
    A["Ouvrir le carton\ndans la chambre"] --> B["Poser le rouleau\nsur le sommier"]
    B --> C["Couper le film\navec des ciseaux"]
    C --> D["Dérouler\nsur le support"]
    D --> E["Aérer la pièce\n24-72h minimum"]
    E --> F["Installer les draps\net profiter !"]

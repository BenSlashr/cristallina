---
title: "Décoration shabby chic : idées et photos pour s'inspirer"
description: "Bois blanchi, roses anciennes, patine douce... Tout pour adopter le style shabby chic chez toi avec des idées concrètes et des photos inspirantes."
type: guide
branch: decoration
parent: decoration
order: 10
...
```mermaid
graph TD
    A["Palette shabby chic"]
    A --> B["Blanc cassé / Ivoire"]
    A --> C["Rose poudré"]
    A --> D["Bleu pastel"]
    A --> E["Vert menthe"]
    A --> F["Gris perle / Lin"]
...
```mermaid
flowchart LR
    A["Shabby chic<br/>authentique"] --> B["Meubles patinés"]
    A --> C["Textiles doux"]
    A --> D["Accessoires vintage"]
    B --> E["Peindre en blanc"]
    B --> F["Patine et usure"]
    C --> G["Lin, dentelle, fleurs"]
    D --> H["Bougies, livres, vases"]

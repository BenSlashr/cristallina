---
title: "Décoration vintage : 50 idées et inspirations pour un intérieur rétro chic"
description: "50 idées déco vintage pour transformer ton intérieur. Du salon à la cuisine, adopte le style rétro avec nos conseils pratiques et inspirations."
type: guide
branch: decoration
parent: decoration
order: 2
...
```mermaid
graph TD
    A["Les grandes époques vintage"]
    A --> B["Années 50"]
    A --> C["Années 60"]
    A --> D["Années 70"]
    A --> E["Années 80"]

    B --> B1["Formica, couleurs pop"]
    C --> C1["Pieds compas, teck"]
    D --> D1["Rotin, macramé, ocre"]
    E --> E1["Memphis, formes audacieuses"]
...
```mermaid
flowchart LR
    A["Équilibre vintage / moderne"]
    A --> B["Règle des 30/70"]
    A --> C["Palette cohérente"]
    A --> D["Matières naturelles"]

    B --> B1["30% vintage, 70% actuel"]
    C --> C1["2-3 couleurs fil rouge"]
    D --> D1["Bois, métal, tissu"]

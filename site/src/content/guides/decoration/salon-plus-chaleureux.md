---
title: "Salon chaleureux : 10 astuces pour un espace cocooning"
description: "Rends ton salon plus chaleureux avec ces 10 astuces simples. Couleurs chaudes, textiles douillets et éclairage pour une ambiance cocooning."
type: guide
branch: decoration
parent: decoration
order: 7
...
```mermaid
graph TD
    A["Canapé"] --> B["2-3 coussins velours/laine"]
    A --> C["Plaid bouclette"]
    D["Sol"] --> E["Tapis berbère ou shaggy"]
    F["Fauteuil"] --> G["Peau de mouton / jeté"]
    B --> H["Ambiance cocooning"]
    C --> H
    E --> H
    G --> H
...
```mermaid
graph LR
    A["Angle libre du salon"] --> B["Fauteuil velours"]
    B --> C["Coussin lombaire"]
    B --> D["Liseuse orientable"]
    B --> E["Guéridon / table d'appoint"]
    B --> F["Petit tapis 80x120"]
    C --> G["Coin lecture chaleureux"]
    D --> G
    E --> G
    F --> G
...
```mermaid
graph TD
    A["Salon chaleureux"] --> B["Couleurs chaudes"]
    A --> C["Textiles superposés"]
    A --> D["Éclairage en couches"]
    A --> E["Bois et matières naturelles"]
    A --> F["Plantes vertes"]
    A --> G["Coin lecture"]
    A --> H["Bougies et senteurs"]
    A --> I["Murs habillés"]
    A --> J["Mobilier arrondi"]
    A --> K["Détails soignés"]

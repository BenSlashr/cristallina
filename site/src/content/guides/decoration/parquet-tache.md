---
title: "Parquet taché : comment rattraper et protéger ton sol en bois"
description: "Ton parquet est taché ? Découvre les techniques efficaces pour enlever taches d'eau, de gras ou de vin sur parquet massif, vitrifié ou huilé."
type: guide
branch: decoration
parent: decoration
order: 7
...
```mermaid
graph TD
    A["Tache sur ton parquet"] --> B{"Quel type de tache ?"}
    B -->|Eau / auréole| C["Vinaigre blanc dilué<br>ou huile d'entretien"]
    B -->|Gras| D["Terre de Sommières<br>4-8h puis aspirer"]
    B -->|Vin rouge| E["Sel fin + bicarbonate<br>+ eau oxygénée"]
    B -->|Tache noire| F["Acide oxalique<br>ou ponçage local"]
    B -->|Peinture / vernis| G["Gratter doucement<br>puis white spirit"]
...
```mermaid
graph LR
    A["Entretien régulier"] --> B["Aspirer 1x/semaine"]
    B --> C["Serpillère humide<br>1x/semaine"]
    C --> D["Huile d'entretien<br>tous les 6-12 mois"]
    D --> E["Parquet protégé<br>et durable"]

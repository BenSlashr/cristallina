---
title: "Brise-vue : quel modèle choisir pour ton balcon, terrasse ou jardin ?"
description: "Brise-vue naturel, synthétique ou végétal : comparatif des solutions d'occultation pour balcon et terrasse. Prix, pose et durabilité."
type: guide
branch: decoration
parent: decoration
order: 8
...
graph TD
    ...
    A --> D["Végétal vivant"]
    B --> B1["Canisse bambou\nCanisse osier\nBrande de bruyère"]
    C --> C1["Haie artificielle\nToile tissée\nLamelles PVC\nPanneaux composites"]
    D --> D1["Plantes grimpantes\nJardinière brise-vue\nMur végétal"]
